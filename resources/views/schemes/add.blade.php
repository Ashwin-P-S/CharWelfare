...
@section('content')
    <div class="container px-5">
        <div class="card" style="background: #1F2544">
            <div class="card-header text-white border-white">{{ __('Add Scheme') }}</div>

            <div class="card-body">
                <form method="POST" action="{{ route('schemes.register') }}">
                    @csrf
                    ...
                    <!-- Type of Disability -->
                    <div class="row mb-3">
                        <label for="disability" class="col-md-4 col-form-label text-md-end">{{ __('Type of Disability') }}</label>

                        <div class="col-md-6">
                            <input id="disability" type="text" class="form-control @error('disability') is-invalid @enderror"
